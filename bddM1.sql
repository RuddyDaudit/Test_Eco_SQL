...
(
     ...
     CONSTRAINT sal_inf CHECK(SALAIRE_BASE<=SALAIRE_ACTUEL)
);
...
(
     ...
     NUM_COURS       Number(4),
     POINTS          Number,
     CONSTRAINT PK_RESULTATS                     PRIMARY KEY(NUM_ELEVE,
NUM_COURS)
     CONSTRAINT max_min_POINTS CHECK(POINTS => 0 AND POINTS <= 20)
);
...
(
     ...
     NIVEAU          Number(1),
     NOM             VARCHAR2(20),
     CONSTRAINT PK_ACTIVITES_PRATIQUEES         PRIMARY KEY(NUM_ELEVE,
NIVEAU, NOM)
);
...
Insert into eleves (Num_eleve, nom, prenom, date_naissance, Poids,
annee, sexe)
...
Values(1, 'Bottle', 'poésie', '01-10-1970', '01-10-1988', 2000000,
2600000) ;

Insert into PROFESSEURS (Num_prof, nom , specialite, Date_entree,
Der_prom, Salaire_base, Salaire_actuel)
Values(2, 'Bolenov', 'réseau', '15-11-1968', '01-10-1998', 1900000,
2468000) ;

Insert into PROFESSEURS (Num_prof, nom , specialite, Date_entree,
Der_prom, Salaire_base, Salaire_actuel)
Values(3, 'Tonilaclasse', 'poo', '01-10-1979', '01-01-1989', 1900000,
2360000) ;
...
Insert into PROFESSEURS (Num_prof, nom , specialite, Date_entree,
Der_prom, Salaire_base, Salaire_actuel)
Values(5, 'Selector', 'sql', '15-10-1982', '01-10-1988', 1900000,
1900000) ;

Insert into PROFESSEURS (Num_prof, nom , specialite, Date_entree,
Der_prom, Salaire_base, Salaire_actuel)
Values(6, 'Vilplusplus', 'poo', '25-04-1990', '05-06-1994', 1900000,
2200000) ;
...
Insert into PROFESSEURS (Num_prof, nom , specialite, Date_entree,
Der_prom, Salaire_base, Salaire_actuel)
Values(8, 'Pucette', 'sql', '06-12-1988', '29-02-1996', 2000000,
2500000) ;
